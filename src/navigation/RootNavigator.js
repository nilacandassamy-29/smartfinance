                ...
                >
                    <View className="items-center space-y-8">
                        ...
                        <View className="items-center">
                            <Text className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.5em] italic">Neural Link Active</Text>
                            <Text className="text-4xl font-black text-white tracking-tighter italic mt-2 uppercase">SmartFinance</Text>
                            <BlurView intensity={10} tint="dark" className="px-6 py-2 rounded-xl mt-6 border border-white/5 opacity-40">
                                <Text className="text-slate-500 font-black text-[8px] uppercase tracking-[0.3em] italic">Syncing Matrix Core...</Text>
                            </BlurView>
                        </View>
                    </View>
                </LinearGradient>
