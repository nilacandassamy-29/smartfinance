...
export const generateFinancialReport = async (metrics, userProfile) => {
 ...
 <div class="card-value">₹${metrics.balance.toLocaleString('en-IN')}</div>
 </div>
 <div class="card">
 ...
 <div class="card-value">₹${metrics.income.toLocaleString('en-IN')}</div>
 </div>
 <div class="card">
 <div class="card-label">Total Outflow</div>
 <div class="card-value">₹${metrics.expenses.toLocaleString('en-IN')}</div>
 </div>
 </div>
