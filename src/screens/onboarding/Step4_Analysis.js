        ...
        <OnboardingLayout currentStep={4}>
            <View className="mb-10 flex-row items-center justify-between">
                ...
                <BlurView intensity={20} tint="dark" className="px-4 py-2 rounded-xl border border-white/5 overflow-hidden">
                    <Text className="text-[9px] font-black text-emerald-400 uppercase tracking-[0.3em] italic">
                        Processing Engine
                    </Text>
                </BlurView>
            </View>
            ...
            <View className="mb-12 items-center">
                ...
                <Text className="text-4xl font-black text-white tracking-tighter uppercase italic text-center">
                    ...
                    >
                        <BlurView intensity={15} tint="dark" className={`p-8 flex-row items-center justify-between ${card.bg}`}>
                            <View className="flex-row items-center space-x-6">
                                ...
                                <View>
                                    <Text className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em] mb-2">{card.label}</Text>
                                    <Text className="text-3xl font-black text-white italic tracking-tighter">
                                        ₹{safeNumber(card.value).toLocaleString()}
                                    </Text>
                                </View>
                            </View>
            ...
            >
                <BlurView intensity={40} tint="dark" className="p-8 flex-row items-start space-x-6 bg-indigo-600/10">
                    ...
                    <View className="flex-1">
                        <Text className="font-black text-white uppercase tracking-[0.4em] text-[10px] italic mb-3">Advisor Synthesis</Text>
                        <Text className="text-slate-400 font-bold leading-relaxed text-[13px] italic">
                            {initialSurplus > 0
                                ? `Protocol optimized! Monthly surplus of ₹${initialSurplus.toLocaleString()} detected. Capital is primed for AI-accelerated growth loops.`
            ...
            >
                <Text className="text-white font-black text-xs uppercase tracking-[0.3em] italic">Generate Deployment Strategy</Text>
