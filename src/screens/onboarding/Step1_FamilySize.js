    ...
    <OnboardingLayout currentStep={1}>
      <View style={{ marginBottom: 40 }}>
        ...
        >
          ...
          <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 11, letterSpacing: 0.5, color: C.sub }}>
            Go Back
          </Text>
        </TouchableOpacity>
            ...
            {familySize > 1 && (
              ...
              >
                ...
                <View style={{ alignItems: 'center', width: 80 }}>
                  ...
                  <Text style={{ fontFamily: 'Poppins_600SemiBold', fontSize: 11, letterSpacing: 0.5, color: C.sub, textAlign: 'center', marginTop: 2 }}>
                    Family Members
                  </Text>
                </View>
      ...
      {familySize > 0 && (
        <MotiView from={{ opacity: 0, translateY: 20 }} animate={{ opacity: 1, translateY: 0 }} style={{ marginTop: 24 }}>
          ...
          >
            <Text style={{ fontFamily: 'Poppins_700Bold', fontSize: 13, letterSpacing: 0.5, color: '#ffffff' }}>
              Continue
            </Text>
