        ...
        <OnboardingLayout currentStep={7}>
            ...
            <View className="items-center space-y-6 mb-12">
                ...
                <View className="items-center px-4">
                    <Text className="text-4xl font-black text-white italic tracking-tighter uppercase text-center leading-none">Matrix Ready</Text>
                    <BlurView intensity={10} tint="dark" className="px-6 py-3 rounded-2xl border border-white/5 bg-white/5 mt-6">
                        <Text className="text-slate-500 font-black text-[9px] uppercase tracking-[0.3em] mt-2 text-center italic">
                ...
                <BlurView intensity={30} tint="dark" className="p-10 bg-slate-900/40">
                        ...
                        {summaries.map((item, i) => (
                            ...
                            >
                                <View className="flex-row items-center space-x-3">
                                    ...
                                    <Text className="text-[9px] font-black text-slate-500 uppercase tracking-[0.3em] italic">{item.label}</Text>
                                </View>
                                <Text className="text-3xl font-black text-white italic tracking-tighter leading-none">
                                    ₹{safeNumber(item.value).toLocaleString()}
                                </Text>
                            </MotiView>
                        ))}
                    </View>
                    ...
                    >
                        ...
                        <View className="flex-1">
                            <Text className="text-[11px] font-bold text-slate-400 leading-relaxed italic uppercase tracking-wider">
            ...
            >
                {isFinalizing ? (
                    <View className="flex-row items-center space-x-4">
                        ...
                        <Text className="text-indigo-400 font-black text-xs uppercase tracking-[0.4em] italic mb-0.5 ml-2">Syncing Matrix...</Text>
                    </View>
                ) : (
                    <View className="flex-row items-center">
                        <Text className="text-white font-black text-xs uppercase tracking-[0.3em] italic">Activate Synth Tracker</Text>
