        ...
        <OnboardingLayout currentStep={5}>
            <View className="mb-10 flex-row items-center justify-between">
                ...
                <BlurView intensity={20} tint="dark" className="px-4 py-2 rounded-xl border border-white/5 overflow-hidden">
                    <Text className="text-[9px] font-black text-indigo-400 uppercase tracking-[0.3em] italic">
                        Liquidity Vault
                    </Text>
                </BlurView>
            </View>
            ...
            <View className="mb-12">
                <Text className="text-4xl font-black text-white tracking-tighter uppercase italic">Resilience Buffer</Text>
                <Text className="text-slate-500 font-bold text-xs mt-3 uppercase tracking-widest leading-relaxed">
                    Defining the absolute safety net from your ₹{initialSurplus.toLocaleString()} surplus.
                </Text>
            </View>
                ...
                <BlurView intensity={25} tint="dark" className="p-10 bg-slate-900/40">
                    <View className="items-center space-y-6 mb-10">
                        ...
                        <View className="items-center">
                            <Text className="font-black text-white text-sm uppercase tracking-[0.4em] italic text-center">Safety Lock Amount</Text>
                            <View className="flex-row items-center mt-3 bg-white/5 px-4 py-2 rounded-xl border border-white/5">
                                ...
                                <Text className="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em]">Objective: 6 Cycle Resilience</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View className="flex-row items-center bg-white/5 rounded-[1.5rem] px-6 h-20 border border-white/5 shadow-inner">
                        ...
                        <TextInput
                            className="flex-1 font-black text-4xl text-white ml-5 italic tracking-tighter"
                            placeholder="0"
                    ...
                    <View className="flex-row items-center space-x-4 mt-10 p-5 bg-indigo-500/5 rounded-2xl border border-indigo-500/10">
                        ...
                        <Text className="text-[10px] font-bold text-slate-500 leading-relaxed uppercase tracking-widest opacity-80">
            ...
            >
                <Text className="text-white font-black text-xs uppercase tracking-[0.3em] italic">Lock Resilience Buffer</Text>
