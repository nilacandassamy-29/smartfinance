export const schemes = {
    ...
    ssy: {
        ...
        institutions: [
            { name: "India Post", type: "Government Institution", contact: "1800 266 6868", website: "https://indiapost.gov.in" },
            { name: "Canara Bank", type: "Public Sector Bank", contact: "1800 425 0018", website: "https://canarabank.com" }
        ]
    },
    scss: {
        id: 'scss',
    ...
    nps: {
        ...
        icon: 'TrendingUp',
        institutions: [
            { name: "PFRDA (NSDL/KFinTech)", type: "Government Regulator", contact: "1800 110 708", website: "https://npscra.nsdl.co.in" },
    ...
    apy: {
        ...
        icon: 'Umbrella',
        institutions: [
            { name: "All Core Banking Banks", type: "Banking Sector", contact: "1800 110 708", website: "https://npscra.nsdl.co.in" }
        ]
    },
    'health-insurance': {
        id: 'health-insurance',
