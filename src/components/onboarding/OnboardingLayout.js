        ...
        return (
            <View className="flex-1 bg-slate-950 items-center justify-center">
                <View className="flex-col items-center">
                    ...
                    <Text className="text-slate-500 font-black text-[10px] uppercase tracking-[0.4em] mt-6 italic">Securing Neural Link...</Text>
                </View>
            </View>
        );
    }
                    ...
                    <View className="w-full px-6 mb-8">
                        <View className="flex-row items-center justify-between mb-8">
                            <View className="flex-row items-center space-x-4">
                                ...
                                <View>
                                    <Text className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.4em]">Initialization</Text>
                                ...
                                <View className="items-end">
                                    {isSyncing ? (
                                        <View className="flex-row items-center space-x-2">
                                            ...
                                            <Text className="text-[8px] font-black text-indigo-400 uppercase tracking-widest italic">Syncing...</Text>
                                        </View>
                                    ) : (
                                        <View className="flex-row items-center space-x-2">
                                            <ShieldCheck size={12} color="#10b981" />
                                            <Text className="text-[8px] font-black text-emerald-400 uppercase tracking-widest">Secured</Text>
                                        </View>
                                    )}
                                </View>
                                <BlurView intensity={20} tint="dark" className="px-3 py-1.5 rounded-xl border border-white/5 overflow-hidden">
                                    <Text className="text-white text-[9px] font-black uppercase tracking-widest italic">{currentStep} / {totalSteps}</Text>
                                </BlurView>
                            </View>
                        </View>
                    ...
                    >
                        ...
                        <View className="flex-row items-center justify-center space-x-6 mb-10 opacity-40">
                            <View className="flex-row items-center space-x-2">
                                ...
                                <Text className="text-[9px] font-black text-slate-500 uppercase tracking-widest">End-to-End Encryption</Text>
                            </View>
                            <View className="w-1.5 h-1.5 rounded-full bg-slate-800" />
                            <View className="flex-row items-center space-x-2">
                                <ShieldCheck size={12} color="#94a3b8" />
                                <Text className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Biometric Ready</Text>
                            </View>
                        </View>
                    </ScrollView>
                </View>
