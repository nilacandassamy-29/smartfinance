        ...
        <View>
            <View className="flex-row items-center justify-between mb-8">
                <View className="flex-row items-center space-x-4">
                    ...
                    <View>
                        ...
                        <Text className="text-[9px] font-black text-slate-500 uppercase tracking-[0.4em] mt-1">
            ...
            <View className="flex-row items-center justify-between mt-8 p-6 bg-white/5 rounded-3xl border border-white/5 shadow-inner">
                <View className="flex-row items-center space-x-3">
                    ...
                    <Text className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Growth Cluster</Text>
                </View>
