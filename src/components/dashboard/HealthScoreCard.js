            ...
            <View className="flex-row items-center justify-between mb-8">
                <View className="flex-row items-center space-x-4">
                    ...
                    <View>
                        ...
                        <Text className="text-[9px] font-black text-slate-400 uppercase tracking-[0.4em] mt-1">Capital Health Index</Text>
                    </View>
                </View>
                <View className="px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                    <Text className="text-[10px] font-black text-white uppercase tracking-widest">{score}% Efficiency</Text>
                </View>
            </View>
            ...
            <View className="items-center justify-center py-6">
                <View className="w-40 h-40 rounded-full border-[10px] border-white/5 items-center justify-center relative">
                    ...
                    <View className="items-center">
                        <Text style={{ color }} className="text-6xl font-black tracking-tighter italic">{score}</Text>
                        <Text className="text-[8px] font-black text-slate-400 uppercase tracking-[0.4em] mt-1">Alpha Yield</Text>
                    </View>
                </View>
            </View>
