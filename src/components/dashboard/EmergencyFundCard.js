...
const EmergencyFundCard = ({ monthlyExpenses = 0, gap = 0, coverage = 0 }) => {
 ...
 <Text className="text-xs font-black text-slate-500 uppercase tracking-[0.4em] mt-1">Capital Reserves</Text>
 </View>
 ...
 <Text className="text-xs font-black text-slate-500 uppercase tracking-widest">Resilience Index</Text>
 ...
 <Text className="text-xs font-black text-slate-500 uppercase tracking-widest mb-2">Cycle Cost</Text>
 <Text className="text-xl font-black text-white tracking-tighter">₹{monthlyExpenses.toLocaleString('en-IN')}</Text>
 </View>
 <View className="flex-1 bg-white/5 p-5 rounded-2xl border border-white/5">
 <Text className="text-xs font-black text-slate-500 uppercase tracking-widest mb-2">Asset Gap</Text>
 <Text className={`text-xl font-black tracking-tighter ${isSecure ? 'text-emerald-400' : 'text-rose-400'}`}>
 {isSecure ? 'Nominal' : `₹${gap.toLocaleString('en-IN')}`}
 </Text>
 </View>
 </View>
 ...
 <Text className="text-xs font-black text-indigo-400 uppercase tracking-widest mb-1">Optimization Loop</Text>
 <Text className="font-bold text-slate-500 text-xs leading-relaxed">
 ...
 >
 <Text className="text-xs font-black text-slate-500 uppercase tracking-[0.3em]">Query Logic Mapping</Text>
