        ...
        <View className="mb-10">
            <View className="flex-row items-center justify-between mb-8 px-2">
                <View className="flex-row items-center gap-4">
                    ...
                    <View>
                        <Text className="text-2xl font-black text-white uppercase tracking-tight italic">AI Advisor</Text>
                        <Text className="text-[9px] font-black text-slate-500 uppercase tracking-[0.4em] mt-1 italic">Cognitive Wealth Engine</Text>
                    </View>
                </View>
            ...
            {insights.length > 0 ? (
                            ...
                            <View className="flex-row items-start gap-6">
                                ...
                                <View className="flex-1">
                                    <View className="flex-row justify-between items-start mb-3">
                                        <Text className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.3em] italic">{insight.category || 'Core Registry'}</Text>
                                        <ArrowUpRight size={16} color="#475569" />
                                    </View>
                                    <Text className="text-sm font-bold text-white leading-relaxed italic pr-4 mb-4">
                                        {insight.text}
                                    </Text>
                ...
                <View className="bg-white/5 border border-white/10 border-dashed rounded-[3rem] py-16 items-center justify-center">
                    ...
                    <Text className="text-slate-500 font-black text-[10px] uppercase tracking-[0.4em] italic mb-2">Heuristic Scan Complete</Text>
                    <Text className="text-slate-600 text-[9px] font-black uppercase tracking-widest italic">No anomalies detected in current cycle</Text>
                </View>
            )}
            ...
            >
                ...
                <Text className="text-indigo-400 text-[11px] font-black uppercase tracking-[0.4em] italic">Initialize Deep Audit</Text>
            </TouchableOpacity>
        </View>
    );
};
